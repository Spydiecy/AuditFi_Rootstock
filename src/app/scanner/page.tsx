    ...
    <main className="min-h-screen py-12">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">Scan your smart contracts for common vulnerabilities and security issues</p>
        </div>
            ...
            {result ? (
              ...
              <div className="h-full flex flex-col items-center justify-center text-gray-400 bg-gray-900/50 rounded-lg border border-gray-800 p-10">
                ...
                <p className="text-center mb-6">
                  Paste your smart contract code and scan for potential vulnerabilities and security issues.
                </p>
